...
<div class="flex items-center justify-center mt-24">
    <div class="px-8 py-6 mx-4 mt-4 text-left bg-white shadow-lg md:w-1/3 lg:w-1/3 sm:w-1/3">
        <h3 class="text-2xl font-bold text-center">Registrar um Cliente</h3>
        <form wire:submit.prevent="create">
            @csrf
            <div class="mt-4">
                <div>
                    <label class="block" for="name">Nome</label>
                    <input type="text" placeholder="nome" name="name" id="name" wire:model="name"
                ...
                <div class="mt-4">
                    ...
                    <input type="text" placeholder="telefone" name="phone" id="phone"
                           wire:model="phone"
                           class="w-full px-4 py-2 mt-2 border rounded-md focus:outline-none focus:ring-1 focus:ring-blue-600">
                </div>
                <div>
